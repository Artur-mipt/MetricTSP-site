...
function Description() {
  return (
    <div className="pricing-header px-3 py-3 pt-md-0 pb-md-4 mx-auto text-center">
      <h1 className="display-4">Задача коммивояжёра</h1>
      <p className="lead">Одна из самых известных задач комбинаторной оптимизации, заключающаяся в поиске самого выгодного маршрута, 
